...
// Problem 2 - Event director wants Kermit case bibs, because that sounds fun
let KermitName = runners.map(i => {return `${i.first_name.toLowerCase()}${i.last_name}`});
console.log(KermitName)
